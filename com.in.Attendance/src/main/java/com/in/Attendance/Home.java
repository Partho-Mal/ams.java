...
public class Home{
	...
	public void homeView(int id) throws SQLException {
		...
		/*String userRole = getUserRole(id);
		String welcomeMessage = "Welcome ";
		if ("Teacher".equals(userRole)) {
			welcomeMessage += "Teacher ";
		} else if ("Admin".equals(userRole)) {
			welcomeMessage += "Admin ";
		}
		welcomeMessage += getUser(id) + ",";
...
//--------------------------------------
	/*String userRole = "";
    // Fetch the user's role from the database based on their ID
    String url = "jdbc:mysql://localhost:3306/attendance";
    String user = "root";
    String pass = "12345678";
    Connection con = DriverManager.getConnection(url, user, pass);
  ...
  public String getUser(int id) throws SQLException {
	...
	try {
		...
		// Handle the SQLException here, you can log it or display an error message
